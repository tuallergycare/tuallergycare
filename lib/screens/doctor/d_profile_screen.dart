...
//  Future<void> setImage() async {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<Object>(
      stream: FirebaseFirestore.instance.collection('doctors').doc(currentDoctor.uid).snapshots(),
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: [
                                      ...
                                      buildInfoDoctor('ส่วนสูง', _heightDoctor),
                                      buildInfoDoctor('น้ำหนัก', _weightDoctor),
                                      buildInfoDoctor(
